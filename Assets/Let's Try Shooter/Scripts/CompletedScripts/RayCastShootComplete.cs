...
public class RayCastShootComplete : MonoBehaviour {
	...
	void FixedUpdate () 
	{
		...
		{
            AudioManager.instance.PlaySound("ballshoot");

            GameObject b = Instantiate(bullet, gunEnd.position, Quaternion.identity) as GameObject;
   ...
   //             //r.velocity = rayOrigin + (fpsCam.transform.forward * weaponRange * 500f);
   //         }
